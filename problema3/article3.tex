...
\begin{document}
    ...
    \begin{thm}
        ...
        camino de costo m\'inimo de $s$ a $v$  en $G$ si solo si $P$ es un camino de $s$ a $v$ $G'$
    \end{thm}
    
    \noindent \textbf{Demostraci\'on} 
    
    \noindent $ \Leftarrow $ Sea $P = \left(v_0,v_1,\dots , v_k \right)$  un camino en $G'$ . 
    ...
    \noindent $\Rightarrow$Ahora sea $P = \left(v_0,\dots,v_k \right)$ un camino de costo m\'inimo de $v_0 = s $ a  $v_k = v$ en $G$ que tiene $k$ aristas (la demostraci\'on la vamos a hacer por inducci\'on en $k$).
    \\
    ...
    \noindent Esto contradice lo que habiamos supuesto , que $\left(v_0,v_1.\dots, v_k\right)$ era un camino de costo m\'inimo en $G$ , luego queda demostrado que para un k arbitrario se cumple. 
    \\*
    Luego por inducci\'on tenemos que un camino de costo m\'inimo de $s$ a $v$ en $G$ corresponde a un camino de $s$ a $v$ en $G'$ 

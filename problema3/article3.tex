...
\begin{document}
    ...
    \noindent Ahora por el resultado anterior sabemos que todo \'arbol de caminos de costo m\'inimo que esta en $G$ tambi\'en esta en $G'$  y viceverza .Luego como el algoritmo de Prim nos 

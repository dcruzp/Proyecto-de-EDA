...
\begin{document}
    ...
    La correctitud de nuestro algoritmo, se debe al cumplimiento de las proposiciones 1, 2 y 3 previamente demostradas, y que
    son una consecuencia de las restricciones impuestas en la orden del problema.\\

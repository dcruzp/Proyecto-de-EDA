...
\begin{document}
    ...
    la aplicaci\'on de la proposici\'on 1 previamente demostrada, una vez verificado que $y$ es alcanzable desde $x$, construido el 
    AACM $T$ iniciando en $x$ y encontrado el camino de$x$ a $y$ en $T$, solo resta quedarse con la arista de mayor costo en dicho camino,
    operaci\'on que realizan las l\'ineas 5-9 del pseudoc\'odigo usando el array $\pi$.

...
\begin{document}
    ...
    \subsection*{\underline{Correctitud del Algoritmo}}
    ...
    \subsection*{\underline{Descripci\'on del problema}} 
    ...
    \subsection*{\underline{Explicaci\'on de la soluci\'on }}
    ...
    \subsection*{\underline{Demostraci\'on  de la correctitud del algoritmo}}

    \noindent La correctitud del algoritmo se basa en la correctitud del algoritmo de Dijkstra visto en conferencia 
    y en la correctitud del algorimo de Prim visto en Conferencia tambi\'en. Adem\'as hay que demostrar que el \'arbol $T$, 
    ...
    Demostraci\'on:\\
    $\Longrightarrow$\\
    Supongamos que la arista $<u,v>$ no pertenezca a alg\'un camino de costo m\'inimo de entonces que va de u a v entonces es
    porque existe arista $<u',v>$  costo menor que ella que pertenece al camino en cuyo caso   
    $\delta\left(s,u\right) + w \left(u,v\right)$ tendr\'ia  costo menor que el camino de costo m\'inimo lo cual es una contradicci\'on.\\
    ...
    \subsection*{\underline{Pseudoc\'odigo del Algoritmo }}
    ...
    de para que cada par de v\'ertices existen dos caminos disjuntos en v\'ertices entre ellos, o sea con almacenar en una lista

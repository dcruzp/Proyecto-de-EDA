...
\begin{document}
    ...
    Dise\~{n}e un algoritmo que dado un grafo no dirigido con costo en las aristas $G = <V, E>$ y los v\'ertices x, $y \in  V$ ,
    ...
    $\Longleftarrow$\\
    La distanci entre 2 v\'ertices v,w se define como la longitud del camino simple m\'as corto entre v y w.(La menor
    cantidad de aristas)\\

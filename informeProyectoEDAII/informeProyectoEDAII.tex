...
\begin{document}
    ...
    y en la correctitud de Prim asi como en los lemas y proposiciones demostrados previamente 
    que permiten garantizar  que el \'arbol $T$ devuelto por el algoritmo, es un \'arbol de caminos de costo m\'inimo, 
    y que la suma del peso de sus aristas es la menor posible.
    ...
    \begin{algorithm}[H] 
        ...
        20-\hspace*{4em}if $childrens[v] \ge 2$ -en caso de que la ra\'iz v  sea art point \\

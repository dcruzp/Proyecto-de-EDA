...
\begin{document}
    ...
    \begin{abstract}
        \noindent En este proyecto articulo vamos a resolver los 4 problemas para el proyecto final de EDA (Estructura de Datos y Algoritmos)
        Para cada problema vamos a dar  una explicaci\'on breve de como se resuleve el problema (cual es el camino para obtener la solucion del problema ) 
        despues vamos a hacer una explici\'on  de todo el marco te\'orico necesario para la soluci\'on del problema . Para despu\'es poner 
        el pseudoc\'odigo del algoritmo . y por \'ultimo la complejidad temporal del algoritmo . El trabajo esta en un repositorio de GitHub en el siguiente enlace 
        \href{ https://github.com/dcruzp/Proyecto-de-EDA}{\textcolor{blue}{click aqui}} . El temario a resolver es el Temario 7 . Y los integrantes del proyecto somos : 
        \begin{itemize}
